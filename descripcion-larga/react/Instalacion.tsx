...
const Instalacion: StorefrontFunctionComponent<Instalacion> = ({}) => {
  ...
  if (InstalacionPorcelanato.indexOf(Instalacion) != -1) {
    return (
      <a
        ...
        href={`https://www.sitios.knownonline.com/atika/RECOMENDACIONES-DE-INSTALACIÓN-ATIKA-PORCELANATOS-Y-CERAMICOS.pdf`}
        target="_blank"
      >
        <img
          title="ficha-tecnica"
          src="/arquivos/instalacion.svg"
          alt="Instalacion"
          className={`${handles.Instalacion}`}
        />
      </a>
    );
    ...
    return (
      <a
        className={`${handles.Instalacion} db tc`}
        href={`https://www.sitios.knownonline.com/atika/RECOMENDACIONES-DE-INSTALACIÓN-ATIKA-ORGÁNICOS-BIONYL.pdf`}
        target="_blank"
      >
        <img
          title="ficha-tecnica"
    ...
    return (
      <a
        className={`${handles.Instalacion} db tc`}
        href={`https://www.sitios.knownonline.com/atika/RECOMENDACIONES-DE-INSTALACIÓN-ATIKA-VINILICOS-FLOORBEST.pdf`}
        target="_blank"
      >
        <img
          title="ficha-tecnica"
  ...
  return <div className={`${handles.Instalacion} db tc`}></div>;
};
